            ...
            if (response.ok) {
                ...
                const updatedUserData: UserData = {
                    ...
                    data: {
                        ...userData.data,
                        bio,
                        avatar: { url: avatarUrl, alt: userData.data.avatar?.alt ?? 'User Avatar' },
                        banner: { url: bannerUrl, alt: userData.data.banner?.alt ?? 'User Banner' },
                        venueManager
                    }
                };
                ...
                // Update userData in local storage/session storage
